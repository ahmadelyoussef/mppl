...
identifier '[' value ']'{$result=$identifier.result + "_AtPosition_" + $value.result ;
$node="value";
}
;
...
{ if($value.result=="0"){$result=$identifier.result + "_AtPairPosition_";}else if ($value.result=="1"){$result=$identifier.result + "1";}
